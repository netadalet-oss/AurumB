...
(()=>{
 ...
 const KEY='aurum.r250.health.v1';
 ...
 function marketRefresh(){event('info','MARKET_REFRESH_ROUTED','Piyasa yenileme isteği Veriler merkez zincirine yönlendirildi');return globalThis.runDataRefresh?.('FULL')??false}
 function health(){
  try{
