...
(function installR226ReliabilityContract(){
 ...
 const MARKET_LAST_KEY='aurum.r226.market.refresh.at',targets=[95,95,90,80,70];
 ...
 /* Market indicators are deliberately event-driven only. App/process start, foreground, device boot and network restoration must never initiate a data fetch. Scheduled jobs and explicit in-app commands retain their existing behavior. */
