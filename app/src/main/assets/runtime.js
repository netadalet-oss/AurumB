...
(function installR222Contract(){
  ...
  globalThis.marketPage=function marketPageR222Unified(){
    ...
    return `<div class="actions r222-market-actions"><button class="ghost-btn" type="button" onclick="goPage('overview')">← Genel Bakışa Dön</button><button class="gold-btn" type="button" onclick="Promise.allSettled([Promise.resolve(cachedMarketIndicators()),refreshAurumFinancePortal(true)]).then(()=>{try{renderCurrentPagePreservingView()}catch{}})">Piyasayı Yenile</button></div><div class="section-head r222-market-head"><div class="section-title"><h2>Piyasa Özeti</h2></div><small>Doğrudan piyasa verisi · kaynaklı haber akışı</small></div>${typeof globalThis.marketIndicatorsMarkup==='function'?globalThis.marketIndicatorsMarkup():''}<section class="r207-portal-wrap r222-unified-portal"><div id="aurumFinancePortal"><div class="card notice"><b>Birleştirilmiş finans portalı hazırlanıyor…</b><p class="muted">Piyasa, ekonomi, şirket ve küresel kaynaklar eşzamanlı taranıyor.</p></div></div></section>`;
  };
