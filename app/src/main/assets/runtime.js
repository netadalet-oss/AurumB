...
(()=>{
  ...
  function fmt(v,k){if(!Number.isFinite(Number(v)))return '—';const d=k==='XU100'?2:(k==='USDTRY'||k==='EURTRY'||k==='EURUSD'?4:2);return Number(v).toLocaleString('tr-TR',{minimumFractionDigits:k==='XU100'?0:d,maximumFractionDigits:d,useGrouping:true})}
